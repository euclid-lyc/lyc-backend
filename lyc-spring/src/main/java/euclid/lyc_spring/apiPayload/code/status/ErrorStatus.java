...
public enum ErrorStatus implements BaseErrorCode {
    ...
    COMMISSION_NOT_TERMINATED(HttpStatus.BAD_REQUEST, "COMMISSION4047", "종료되지 않은 의뢰입니다."),
    COMMISSION_INVALID_DATE(HttpStatus.BAD_REQUEST, "COMMISSION4048", "유효하지 않은 날짜입니다."),
    COMMISSION_STATUS_NOT_WAIT_FOR_TERMINATION(HttpStatus.BAD_REQUEST, "COMMISSION4049", "의뢰 종료 요청 상태가 아닙니다."),
    COMMISSION_STATUS_NOT_APPROVED(HttpStatus.BAD_REQUEST, "COMMISSION4050", "의뢰 승인 상태가 아닙니다."),
    CLIENT_NOT_EQUAL_MEMBER(HttpStatus.BAD_REQUEST, "COMMISSION4051", "의뢰인 권한이 없습니다."),
    DIRECTOR_NOT_EQUAL_MEMBER(HttpStatus.BAD_REQUEST, "COMMISSION4052", "디렉터 권한이 없습니다."),
