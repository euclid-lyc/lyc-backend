...
/*-------------------------------------------------- 피드 --------------------------------------------------*/
    ...
    @Operation(summary = "게시글 미리보기 10개 불러오기", description = "홈 화면에 노출할 최신 피드 10개를 불러옵니다.")
    ...
    @Operation(summary = "날씨 기반 추천 게시글 10개 불러오기", description = "피드 화면에 노출할 날씨 기반 추천 게시글 10개를 불러옵니다.")
    @GetMapping("/feeds/by-weather")
    void getPostingsAccordingToWeather() {}

    @Operation(summary = "회원 맞춤 추천 게시글 목록 불러오기", description = """
...
/*-------------------------------------------------- 게시글 공통 --------------------------------------------------*/
    ...
    @Operation(summary = "게시글 불러오기", description = "게시글(코디 or 리뷰)을 불러옵니다.")
    ...
    @Operation(summary = "게시글 저장하기", description = "게시글을 저장합니다")
    ...
    @Operation(summary = "게시글 저장 취소하기", description = "저장되어 있는 게시글을 삭제합니다.")
    ...
    @Operation(summary = "게시글 좋아요 하기", description = "게시글에 좋아요를 누릅니다.")
    ...
    @Operation(summary = "게시글 좋아요 취소하기", description = "게시글에 좋아요를 취소합니다.")
